...
const groundPlane: THREE.Mesh = new THREE.Mesh(groundPlaneGeometry, material);
...
const groundPlaneFolder = gui.addFolder("Ground Plane");
// groundPlaneFolder.add(groundPlane.);
